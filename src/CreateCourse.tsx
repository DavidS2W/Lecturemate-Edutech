...
function CreateCoursePage(){
    ...
    async function uploadCourse(){
        ...
        const imageURL = await uploadImg(id);
        await setDoc(doc(db, "course_db", id), {title: title, desc: desc, image: imageURL, stories: [], id: id});
    ...
    return(
        <div className="createpage-body">
            <NavBar/>
            <div className="createpage-header">Create a new course</div>
            <div className="createpage-entry-container">
                ...
                <div className="createpage-entry-field-final">
                    <button className="createpage-entry-button" disabled={buttonState} onClick={async()=>{await uploadCourse()}}>Create Course</button>
                </div>
            </div>
        </div>
    )
